...
package hashengineering.franko.wallet.integration.android;
...
public final class BitcoinIntegration
{
	...
	{
		final StringBuilder uri = new StringBuilder("franko:");
		if (address != null)
			uri.append(address);
		if (amount != null)
	...
	{
		Toast.makeText(context, "No Franko application found.\nPlease install Franko Wallet.", Toast.LENGTH_LONG).show();

		final Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=hashengineering.franko.wallet"));
