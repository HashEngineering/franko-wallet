...
package hashengineering.franko.wallet.offline;
...
public abstract class AcceptBluetoothThread extends Thread
{
	...
	public AcceptBluetoothThread(@Nonnull final BluetoothAdapter adapter)
	{
		try
		{
			this.listeningSocket = adapter.listenUsingInsecureRfcommWithServiceRecord("Franko Transaction Submission", Bluetooth.BLUETOOTH_UUID);
		}
